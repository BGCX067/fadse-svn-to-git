...
public class Solution implements Serializable {  
  ...
  private String[] sum = new String[100];
  private double tempSum[] = new double[100];
  /**
   * Constructor.
   */
  public Solution() {        
  ...
  public int getNumberOfBits() {
    ...
    public void setSum(int i,String sum) {
        this.sum[i] = sum;
    }

    public double getTempSum(int i) {
        return tempSum[i];
    }

    public void setTempSum(int i,double tempSum) {
        this.tempSum[i] = tempSum;
    }
