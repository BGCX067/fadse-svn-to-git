...
public class ResultsReceiver implements Runnable {
    ...
    private ResultsReceiver() throws IOException {
        ...
        int port = ini.get("Server", "listenPort", int.class);
                        ...
                        try {
                            ...
                            if (response.getType() != Message.TYPE_RESPONSE) {
                                ...
                                try {
                                    ...
                                    Neighbor n = NeighborhoodSingletonWrapper.getInstance().getByIpAndPort(socket.getInetAddress(), response.getClientListenport());
                                    if (n != null) {
