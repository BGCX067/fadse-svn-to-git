 ...
 * @version 1.1
 */
package extended.base.operator.mutation;
        ...
        try {
            ...
            for (int i = 0; i < params.length; i++) {
                ...
                try {
                    ...
                    Logger.getLogger(BitFlipMutationFuzzyVirtualParameters.class.getName()).log(Level.INFO, "Something went rong for(" + e.getMessage() + "): " + params[i].getName() + ". Switching to old bit flip mutation");
...
//                            e.printStackTrace();
    ...
    private double computeProbabilityGaussian(Variable outputVariable, double probability) {
        ...
        //y = a*e^(-(((x-b)^2)/2*c*c)) + probability //translation
        //a = 1-probability
        //b = 0
