...
package extended.base.variable;
...
public class Constant extends Variable {
	 ...
	 */
	public Constant(int lowerBound, int upperBound){
	 ...
	 * @param upperBound Variable upper bound
	 */
	public Constant(int value, int lowerBound, int upperBound) {
		super();
	 ...
	 * @throws JMException 
	 */
	public Constant(Variable variable) throws JMException{
