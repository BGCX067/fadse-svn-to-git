        ...
        if (p1 != null) {
            for (Parameter p : parameters) {
                if (p.getName().equalsIgnoreCase(p1)) {
                    val1 = (Double) p.getValue();
                }
            }
        } else if (c1 != null) {
            val1 = (Double) c1.getValue();
        } else if (e1 != null) {
            for (Parameter p : parameters) {
                try{
...
//            val1 = ((Double) e1.getValue()).intValue();
            val1 = ((Double) e1.getValue());
        }
        Double val2 = null;
        if (p2 != null) {
            for (Parameter p : parameters) {
                if (p.getName().equalsIgnoreCase(p2)) {
                    val2 = (Double) p.getValue();
                }
            }
        } else if (c1 != null) {
            val2 = (Double) c1.getValue();
        } else if (c2 != null) {
            val2 = (Double) c2.getValue();
        } else if (e2 != null) {
            for (Parameter p : parameters) {
                try{
...
//            val2 = ((Double) e2.getValue()).intValue();
            val2 = ((Double) e2.getValue());
        }
