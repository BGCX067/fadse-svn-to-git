...
//                System.out.printf("param %s - variable %s\n", parameter.getName(), vars[i].getValue());
        ...
        if (environment.getInputDocument().getVirtualParameters() != null) {
            int virtualParamsLength = environment.getInputDocument().getVirtualParameters().length;
            ...
            System.arraycopy(environment.getInputDocument().getVirtualParameters(), 0, params, params.length, params.length + virtualParamsLength);
