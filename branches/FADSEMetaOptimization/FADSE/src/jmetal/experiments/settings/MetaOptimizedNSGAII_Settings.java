...
import jmetal.metaheuristics.metaoptimizations.metaoptimized.MetaOptimizedNSGAII;
 ...
 * @author Antonio J. Nebro
 */
public class MetaOptimizedNSGAII_Settings extends Settings {
   ...
   * @throws JMException 
   */
  public MetaOptimizedNSGAII_Settings(Problem problem) throws JMException {
    super(problem) ;
  } // NSGAII_Settings
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new MetaOptimizedNSGAII(problem_) ;
