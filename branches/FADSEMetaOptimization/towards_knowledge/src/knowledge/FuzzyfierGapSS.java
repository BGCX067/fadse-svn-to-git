...
public class FuzzyfierGapSS {
    ...
    public static void main(String[] args) {
        ...
        FuzzyParameter para_2 = new FuzzyParameter("n_layers", 0, 6, false);
        paras.add(para_2);

        FuzzyParameter para_4 = new FuzzyParameter("c_sets", 5, 13, false);
        paras.add(para_4);

        FuzzyParameter para_5 = new FuzzyParameter("c_lines", 0, 7, false);
        paras.add(para_5);

        ArrayList<FuzzyRule> rules = new ArrayList<FuzzyRule>();

        FuzzyRule rule_1 = new FuzzyRule();
        rule_1.addCondition(para_1.getLltInterval(LltInterval.MIN, 7));
        rule_1.addCondition(para_2.getLltInterval(LltInterval.MIN, 4));
        rule_1.addCondition(para_4.getLltInterval(LltInterval.MIN, 11));
        rule_1.consequence = para_5.getLltInterval(LltInterval.MIN, 4);
        rules.add(rule_1);

        FuzzyRule rule_2 = new FuzzyRule();
        rule_2.addCondition(para_1.getLltInterval(LltInterval.MIN, 12));
        rule_2.addCondition(para_2.getLltInterval(4, LltInterval.MAX));
        rule_2.addCondition(para_4.getLltInterval(9,12));
        rule_2.consequence = para_5.getLltInterval(LltInterval.MIN, 1);
        rules.add(rule_2);

        FuzzyRule rule_3 = new FuzzyRule();
        rule_3.addCondition(para_1.getLltInterval(LltInterval.MIN, 12));
        rule_3.addCondition(para_2.getLltInterval(4, LltInterval.MAX));
        rule_3.addCondition(para_4.getLltInterval(LltInterval.MIN, 12));
        rule_3.consequence = para_5.getLltInterval(1, 4);
        rules.add(rule_3);

        FuzzyRule rule_4 = new FuzzyRule();
        rule_4.addCondition(para_1.getLltInterval(LltInterval.MIN, 12));
        rule_4.addCondition(para_2.getLltInterval(4, LltInterval.MAX));
        rule_4.addCondition(para_4.getLltInterval(12, LltInterval.MAX));
        rule_4.consequence = para_5.getLltInterval(LltInterval.MIN, 2);
        rules.add(rule_4);
      
        // For Completeness
        
        FuzzyRule correct_para_1 = new FuzzyRule(true);
        correct_para_1.addCondition(para_1.getLltInterval(13, LltInterval.MAX));
        correct_para_1.consequence = para_1.getLltInterval(LltInterval.MIN, 13);
        rules.add(correct_para_1);

        FuzzyRule correct_para_5 = new FuzzyRule(true);
        correct_para_5.addCondition(para_5.getLltInterval(5, LltInterval.MAX));
